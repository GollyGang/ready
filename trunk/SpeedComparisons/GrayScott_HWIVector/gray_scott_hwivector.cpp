...
void colorize(float *u, float *v, float *du, float *red, float *green, float *blue);
void go_hsv2rgb(float h, float s, float v, float *red, float *green, float *blue);
void color_mapping(float u0, float v0, float dU, int pm, float *red, float *green, float *blue);
             ...
             float *red, float *green, float *blue)
{
  ...
  for(long i = 0; i < g_height; i++) {
    ...
    for(long j = 0; j < g_width; j++) {
      ...
      float delta_u = INDEX(du,i,j);

      color_mapping(uval, vval, delta_u, g_oldcolor, &r, &g, &b);
      INDEX(red,i,j) = r;
      INDEX(green,i,j) = g;
      INDEX(blue,i,j) = b;
    }
